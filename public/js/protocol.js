...
(function () {
    ...
    for (let i = 1; i <= 57; i++) {
        ...
        let input_type = t.getAttribute("input-type")
        let field_name = t.getAttribute("field-name")
        switch (color) {
            case "1":
                 ...
                 <span title="Автоматическая валидация" class="input-group-text"
                     ...
                     <div class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                                 ...
                                 <div class="d-grid gap-2">
                                    <!-- Button trigger modal -->
                                    <button type="button" class="btn btn-outline-danger" data-bs-toggle="modal" data-bs-target="#new_value${i}">
                                     Изменить
                                     </button>
            ...
            `)
                switch (input_type) {
                    ...
                    case "select": t.insertAdjacentHTML('beforeend', `
                <!-- Modal -->
              <div class="modal fade" id="new_value${i}" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
                  ...
                  <div class="modal-dialog modal-xl">
                              ...
                              <div class="row justify-content-center mt-3">
                                  ...
                                  <div class="m-3">
                                      ...
                                      <div class="mb-2">
                                          ...
                                          <select id="new_value_${i}" name="${field_name}" class="form-select">
                    ...
                    default: t.insertAdjacentHTML('beforeend', `
                                      <!-- Modal -->
                                    <div class="modal fade" id="new_value${i}" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
                                        aria-labelledby="new_value${i}" aria-hidden="true">
                                        <div class="modal-dialog modal-xl">
                                                ...
                                                <div class="modal-body">
                                                    <div class="row justify-content-center mt-3">
                                                        ...
                                                        <div class="m-3">
                                                            ...
                                                            <div class="mb-2">
                                                                <label class="form-label">Новое значение:</label>
                                                                <input id="new_value_${i}" type="${input_type}" class="form-control" name="new_value">
                                                            </div>
